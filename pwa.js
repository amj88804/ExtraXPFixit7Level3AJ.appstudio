...
const cacheName = 'ExtraXPFixit7Level3AlexandraJoas-2020-10-17 10:53:09.503786'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'ExtraXPFixit7Level3AlexandraJoas'.length) === 'ExtraXPFixit7Level3AlexandraJoas') {
